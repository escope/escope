...
<?php /* How to display all other posts. */ ?>
	...
	<?php else : ?>
		<div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
			...
			<a href="<?php the_permalink(); ?>" class="featuredImage">
...
<?php if (  $wp_query->max_num_pages > 1 ) : ?>
				...
				<div id="prevNext">
					<div class="prev"><?php next_posts_link( __( 'По-стари', 'escope' ) ); ?></div>
					<div class="next"><?php previous_posts_link( __( 'По-нови', 'escope' ) ); ?></div>
				</div><!-- #nav-below -->
<?php endif; ?>
